 ...
 * @author said
 */
@Named(value = "mpMajorMB")
@ViewScoped
public class MpMajorMB implements Serializable {
    ...
    private MpMajor item;
    private List<MpMajor> items;
    private List<MpGeneralMajor> generalMajors;

    @Inject
    private MpMajorBean bean;
    @Inject
...
//        prepareCreate();
    ...
    public MpMajor getItem() {
        return item;
    }

    public void setItem(MpMajor item) {
        this.item = item;
    }

    public List<MpMajor> getItems() {
        return items;
    }

    public void setItems(List<MpMajor> items) {
        this.items = items;
    }
